...
# #EX 7.3.1:
# print(try_update_letter_guessed("a", ['c','d','a','v','r','w']))


# # #check
# # secret_word = "Whatever you are, be good at it"
# # letters_guessed = ['a', 'd']
# # print(show_hidden_words(secret_word, letters_guessed))
...
# # secret_word = "friends"
# # secret_word2 = "yes"
# # old_letters_guessed = ['m', 'p', 'j', 'i', 's', 'k', 's', 'e', 'y']
# # print(check_win(secret_word, old_letters_guessed))
# # print(check_win(secret_word2, old_letters_guessed))
...
# 	file.close()
# 	return (len(words_list), content_list[(index-1) % len(content_list)])

# print(choose_word(r"C:\dan\new\found.txt", 15))
...
# 	print("E2")
# else:
# 	print("The letter you chose is: '" + user_guess + "'")
